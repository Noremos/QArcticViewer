...
const std::string base = "/home/art/m/qarctic/QArcticViewer/test_d/base.tif";
const std::string lzw  = "/home/art/m/qarctic/QArcticViewer/test_d/lzw.tif";
...
//    std::ifstream f2("D:/Pictures/_TIFF_lzw1/base.tif", std::ios::in | std::ios::binary | std::ios::ate);
    ...
    for (int j = 0; j < repeat; ++j) {
        ...
        for (int i = 0; i < runs; ++i) {
            dec.decompress(reinterpret_cast<uchar*>(lzwFirstStrip.data()), lzwFirstStrip.size(), ba);
